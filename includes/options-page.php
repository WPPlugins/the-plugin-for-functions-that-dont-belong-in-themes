...
function tpfftdbit_options_page() {
	...
	<div class="wrap">
		...
		<form method="post" action="options.php">
			...
			<p>
				<input id="tpfftdbit_settings[favicon]" type="text" size="36" name="tpfftdbit_settings[favicon]" value="<?php echo esc_url($tpfftdbit_options['favicon']); ?>" />
			...
			<p>
				<input id="tpfftdbit_settings[login_logo]" type="text" size="36" name="tpfftdbit_settings[login_logo]" value="<?php echo esc_url($tpfftdbit_options['login_logo']); ?>" />
			...
			<p>
				<input id="tpfftdbit_settings[draft_color]" name="tpfftdbit_settings[draft_color]" size="10" type="text" value="<?php echo esc_html ( $tpfftdbit_options['draft_color'] ); ?>" />
				<label class="description" for="tpfftdbit_settings[draft_color]"><?php _e('Enter the CSS color for drafts', 'tpfftdbit'); ?></label>
			</p>
			
			<p>
				<input id="tpfftdbit_settings[pending_color]" name="tpfftdbit_settings[pending_color]" size="10" type="text" value="<?php echo esc_html ( $tpfftdbit_options['pending_color'] ); ?>" />
			...
			<p>
				<input id="tpfftdbit_settings[publish_color]" name="tpfftdbit_settings[publish_color]" size="10" type="text" value="<?php echo esc_html ( $tpfftdbit_options['publish_color'] ); ?>" />
			...
			<p>
				<input id="tpfftdbit_settings[future_color]" name="tpfftdbit_settings[future_color]" size="10" type="text" value="<?php echo esc_html ( $tpfftdbit_options['future_color'] ); ?>" />
				<label class="description" for="tpfftdbit_settings[future_color]"><?php _e('Enter the CSS color for future posts', 'tpfftdbit'); ?></label>
			</p>
			
			<p>
				<input id="tpfftdbit_settings[private_color]" name="tpfftdbit_settings[private_color]" size="10" type="text" value="<?php echo esc_html ( $tpfftdbit_options['private_color'] ); ?>" />
			...
			<p>
				<textarea id="tpfftdbit_settings[head_scripts]" name="tpfftdbit_settings[head_scripts]" cols="50" rows="8"><?php echo esc_textarea ( $tpfftdbit_options['head_scripts'] ); ?></textarea>
			...
			<p>
				<textarea id="tpfftdbit_settings[footer_scripts]" name="tpfftdbit_settings[footer_scripts]" cols="50" rows="8"><?php echo esc_textarea ( $tpfftdbit_options['footer_scripts'] ); ?></textarea>
