...
function tpfftdbit_head_scripts() {
	...
	// adds header scripts
	if ($tpfftdbit_options['enable_head_scripts'] == true && !empty($tpfftdbit_options['head_scripts'])) {
		echo wp_kses ( $tpfftdbit_options['head_scripts'], array (
			'script' => array(
				'type' => array(),
				'src' => array()
			),
...
function tpfftdbit_footer_scripts() {
	...
	if ($tpfftdbit_options['enable_footer_scripts'] == true && !empty($tpfftdbit_options['footer_scripts'])) {
		echo wp_kses ( $tpfftdbit_options['footer_scripts'], array (
			'script' => array(
				'type' => array(),
				'src' => array()
			),
